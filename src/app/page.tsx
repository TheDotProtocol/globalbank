          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {["Savings", "Current", "Fixed Deposit", "Corporate", "Junior", "Pension"].map((type, index) => (
                <div key={type} className={`p-6 bg-white/90 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border border-gray-200/50 dark:border-gray-700/50 ${isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{ transitionDelay: `${index * 100}ms` }}>
                  ...
                  <button onClick={() => window.location.href = "/register"} className="mt-auto px-4 py-2 bg-gradient-to-r from-blue-500 to-indigo-500 text-white rounded-full hover:from-blue-600 hover:to-indigo-600 transition-all duration-300 shadow-lg hover:shadow-xl">
                    Open {type}
                  </button>
                </div>
              ))}
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                <div key={feature.title} className={`p-6 bg-white/90 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border border-gray-200/50 dark:border-gray-700/50 ${isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`} style={{ transitionDelay: `${index * 100}ms` }}>
